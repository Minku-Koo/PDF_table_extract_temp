...
def make_google_sheets(sheet_name, json_file_name, tables, header=None, **kwargs):
    '''
    ...
    gc = gspread.service_account(json_file_name)
...
make_google_sheets(sheet_name, json_file_name,tables, header="c")